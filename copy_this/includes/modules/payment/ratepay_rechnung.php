...
class ratepay_rechnung extends ratepay_abstract
{
    ...
    public function install() 
    {
        ...
        tep_db_query("INSERT INTO " . TABLE_CONFIGURATION . " (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, set_function, date_added) VALUES ('" . MODULE_PAYMENT_RATEPAY_RECHNUNG_STATUS_TITLE_DE . "', 'MODULE_PAYMENT_RATEPAY_RECHNUNG_STATUS_DE', 'True', '" . MODULE_PAYMENT_RATEPAY_RECHNUNG_STATUS_DE_DESC . "', '6', '1', 'tep_cfg_select_option(array(\'True\', \'False\'), ', now())");
        ...
        tep_db_query("INSERT INTO " . TABLE_CONFIGURATION . " (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, set_function, date_added) VALUES ('" . MODULE_PAYMENT_RATEPAY_RECHNUNG_STATUS_TITLE_AT . "', 'MODULE_PAYMENT_RATEPAY_RECHNUNG_STATUS_AT', 'False', '" . MODULE_PAYMENT_RATEPAY_RECHNUNG_STATUS_AT_DESC . "', '6', '1', 'tep_cfg_select_option(array(\'True\', \'False\'), ', now())");
        ...
        tep_db_query("INSERT INTO " . TABLE_CONFIGURATION . " (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, set_function, date_added) VALUES ('" . MODULE_PAYMENT_RATEPAY_RECHNUNG_STATUS_TITLE_CH . "', 'MODULE_PAYMENT_RATEPAY_RECHNUNG_STATUS_CH', 'False', '" . MODULE_PAYMENT_RATEPAY_RECHNUNG_STATUS_CH_DESC . "', '6', '1', 'tep_cfg_select_option(array(\'True\', \'False\'), ', now())");
