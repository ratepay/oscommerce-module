                                                    ...
                                                    <table style="border: 1px solid #CCCCCC; width: 100%">
                                                        ...
                                                        while ($item = tep_db_fetch_array($query)) {
                                                            ...
                                                            if ($item['article_name'] != 'pi-Merchant-Voucher' && $item['article_number'] != 'SHIPPING' && $arr[0] != 'DISCOUNT') {
                                                                ...
                                                                <?php
                                                            } else if ($item['article_number'] == 'SHIPPING') {
                                                                ...
                                                                <tr class="dataTableRow">
                                                                    ...
                                                                    <td class="dataTableContent piRpRight"><?php if($shippingPrice > 0):echo number_format($item['tax']/$item['article_netUnitPrice']*100, 0);else:echo 0;endif; ?>%</td>
                                                    ...
                                                    <table style="border: 1px solid #CCCCCC; width: 100%">
                                                        ...
                                                        while ($item = tep_db_fetch_array($query)) {
                                                            ...
                                                            if ($item['article_number'] == 'SHIPPING') {
                                                                ...
                                                                <?php
                                                            } else if ($item['article_number'] == 'COUPON') {
                                                                ?>
                                                                <tr class="dataTableRow">
                                                                    <td class="dataTableContent"><input type="text" size="3"
                                                                                                        maxlength="4" value="<?php echo $qty; ?>"
                                                                ...
                                                                <?php
                                                            } else if ($item['article_name'] != 'pi-Merchant-Voucher') {
                                                                ?>
                                                                <tr class="dataTableRow">
                                                                    <td class="dataTableContent"><input type="text" size="3"
                                                                                                        maxlength="4" value="<?php echo $qty; ?>"
                                                ...
                                                <table style="border: 1px solid #CCCCCC; width: 100%">
                                                    ...
                                                    while ($item = tep_db_fetch_array($query)) {
                                                        ...
                                                        if (!empty($item['article_number'])) {
                                                            if ($item['article_number'] == "SHIPPING" || $arr[0] == "DISCOUNT" || $item['article_number'] == "COUPON" || $item['article_name'] == 'pi-Merchant-Voucher') {
                                                                ?>
                                                                <tr class="dataTableRow">
