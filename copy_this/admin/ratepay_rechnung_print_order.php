...
<html <?php echo HTML_PARAMS; ?>>
    ...
    <body>
                ...
                <td>
                    <table border="0" cellspacing="0" cellpadding="2">
                        <tr>
                            ...
                            <td class="main">RatePAY Rechnung</td>
                        </tr>
                    </table>
                </td>
            </tr>
        ...
        <div style="border-style:solid;border-width:1px;width:75%;padding:10px;font-family:Verdana;font-size:11px;">
            <p><?php echo RATEPAY_RECHNUNG_PDF_PAYUNTIL; ?></p>
            <p><?php echo RATEPAY_RECHNUNG_PDF_PAYTRANSFER; ?></p>
            <span><?php echo RATEPAY_RECHNUNG_PDF_ACCOUNTHOLDER; ?> <?php echo $piRatepay->shopOwner; ?></span><br/>
            <span><?php echo RATEPAY_RECHNUNG_PDF_BANKNAME; ?> <?php echo $piRatepay->shopBankName; ?></span><br/>
            <span><?php echo RATEPAY_RECHNUNG_PDF_BANKCODENUMBER; ?> <?php echo $piRatepay->shopSortCode; ?></span><br/>
            <span><?php echo RATEPAY_RECHNUNG_PDF_ACCOUNTNUMBER; ?> <?php echo $piRatepay->shopAccountNumber; ?></span><br/>
            <span><b><?php echo RATEPAY_RECHNUNG_PDF_REFERENCE; ?> <?php echo Db::getRatepayOrderDataEntry(Globals::getParam('oID'), 'descriptor'); ?></b></span><br/>
            <span><?php echo RATEPAY_RECHNUNG_PDF_INTERNATIONALDESC; ?></span><br/>
            <span><?php echo RATEPAY_RECHNUNG_PDF_SWIFTBIC; ?> <?php echo $piRatepay->shopSwift; ?> <?php echo RATEPAY_RECHNUNG_PDF_IBAN; ?> <?php echo $piRatepay->shopIban; ?></span><br/>
        </div>
        <br/>
        <div style="font-family:Verdana;font-size:11px;">
        <span><?php echo RATEPAY_RECHNUNG_PDF_ADDITIONALINFO_1; ?></span></span><br/>
        <span><?php echo RATEPAY_RECHNUNG_PDF_ADDITIONALINFO_2; ?></span><br/>
        <span><?php echo RATEPAY_RECHNUNG_PDF_ADDITIONALINFO_3; ?></span><br/>
        <span><?php echo RATEPAY_RECHNUNG_PDF_ADDITIONALINFO_4; ?></span></span>
        </div>
        <br/>
        <div style="font-family:Verdana;font-size:11px;">
            ...
            <table style="font-family:Verdana;font-size:8px;font-weight:normal!important;" width="100%">
                <tr>
                    <th style="text-align:left;font-weight:normal!important;">
                        <span><?php echo $piRatepay->shopOwner; ?> <?php echo RATEPAY_RECHNUNG_PDF_BULL; ?> <?php echo $_SERVER['SERVER_NAME']; ?></span><br/>
                        <span><?php echo $piRatepay->shopStreet . ", " . $piRatepay->shopZipCode; ?> <?php echo RATEPAY_RECHNUNG_PDF_BULL; ?> <?php echo RATEPAY_RECHNUNG_PDF_FON; ?> <?php echo $piRatepay->shopPhone; ?> <?php echo RATEPAY_RECHNUNG_PDF_BULL; ?> <?php echo RATEPAY_RECHNUNG_PDF_BULL; ?> <?php echo $piRatepay->shopFax; ?> <?php echo RATEPAY_RECHNUNG_PDF_FAX; ?> <?php echo RATEPAY_RECHNUNG_PDF_EMAIL; ?> <?php echo Db::getShopConfigEntry('STORE_OWNER_EMAIL_ADDRESS'); ?></span><br/>
                        <span><?php echo RATEPAY_RECHNUNG_PDF_OWNER; ?> <?php echo $piRatepay->shopOwner; ?> <?php echo RATEPAY_RECHNUNG_PDF_BULL; ?> <?php echo RATEPAY_RECHNUNG_PDF_COURT; ?> <?php echo $piRatepay->shopCourt; ?> <?php echo RATEPAY_RECHNUNG_PDF_BULL; ?> <?php echo RATEPAY_RECHNUNG_PDF_HR; ?> <?php echo $piRatepay->shopHr; ?> <?php echo RATEPAY_RECHNUNG_PDF_BULL; ?> <?php echo RATEPAY_RECHNUNG_PDF_UST; ?> <?php echo Db::getShopConfigEntry('STORE_OWNER_VAT_ID'); ?></span><br/>
                    </th>
                    <th style="text-align:right;">
                        <img src="../images/ratepay_invoice_logo.png" alt="RatePAY Logo" style="margin-left:5px;"/>
                    </th>
                </tr>
            </table>
        </div>
