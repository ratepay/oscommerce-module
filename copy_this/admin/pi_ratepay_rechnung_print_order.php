...
$sql = "select descriptor from pi_ratepay_rechnung_orders where order_number = '" . $oID . "'";
...
<html <?php echo HTML_PARAMS; ?>>
    ...
    <body>
        ...
        <table border="0" width="100%" cellspacing="0" cellpadding="2">
            ...
            <tr>
                <td>
                    <table border="0" cellspacing="0" cellpadding="2">
                        ...
                        <tr>
                            <td class="main"><strong><?php echo PI_RATEPAY_RECHNUNG_PDF_DESCRIPTOR; ?></strong></td>
            ...
            <tr>
                <td><?php echo PI_RATEPAY_RECHNUNG_PDF_ABOVEARTICLE; ?></td>
            </tr>
            <tr>
                <td>
                    <table border="0" width="100%" cellspacing="0" cellpadding="2">
        ...
        <div style="border-style:solid;border-width:1px;width:75%;padding:10px;font-family:Verdana;font-size:11px;">
            <p><?php echo PI_RATEPAY_RECHNUNG_PDF_PAYUNTIL; ?></p>
            <p><?php echo PI_RATEPAY_RECHNUNG_PDF_PAYTRANSFER ?></p>
            <span><?php echo PI_RATEPAY_RECHNUNG_PDF_ACCOUNTHOLDER; ?> <?php echo $accountHolder; ?></span><br/>
            <span><?php echo PI_RATEPAY_RECHNUNG_PDF_BANKNAME; ?> <?php echo $bank; ?></span><br/>
            <span><?php echo PI_RATEPAY_RECHNUNG_PDF_BANKCODENUMBER; ?> <?php echo $sortCode; ?></span><br/>
            <span><?php echo PI_RATEPAY_RECHNUNG_PDF_ACCOUNTNUMBER; ?> <?php echo $accountNr; ?></span><br/>
            <span><b><?php echo PI_RATEPAY_RECHNUNG_PDF_REFERENCE; ?> <?php echo $descriptor; ?></b></span><br/>
            <span><?php echo PI_RATEPAY_RECHNUNG_PDF_INTERNATIONALDESC; ?></span><br/>
            <span><?php echo PI_RATEPAY_RECHNUNG_PDF_SWIFTBIC; ?> <?php echo $swift; ?> <?php echo PI_RATEPAY_RECHNUNG_PDF_IBAN; ?> <?php echo $iban; ?></span><br/>
        </div>
        <br/>
        <div style="font-family:Verdana;font-size:11px;">
            <span><?php echo PI_RATEPAY_RECHNUNG_PDF_ADDITIONALINFO_1; ?></span></span><br/>
            <span><?php echo PI_RATEPAY_RECHNUNG_PDF_ADDITIONALINFO_2; ?></span><br/>
            <span><?php echo PI_RATEPAY_RECHNUNG_PDF_ADDITIONALINFO_3; ?></span><br/>
            <span><?php echo PI_RATEPAY_RECHNUNG_PDF_ADDITIONALINFO_4; ?></span></span>
        </div>
        <br/>
        <div style="font-family:Verdana;font-size:11px;">
...
<table style="font-family:Verdana;font-size:8px;font-weight:normal!important;" width="100%">
    <tr>
        <th style="text-align:left;font-weight:normal!important;">
            <span><?php echo $owner; ?> <?php echo PI_RATEPAY_RECHNUNG_PDF_BULL; ?> <?php echo $_SERVER['SERVER_NAME']; ?></span><br/>
            <span><?php echo $street . " , " . $plz; ?> <?php echo PI_RATEPAY_RECHNUNG_PDF_BULL; ?> <?php echo PI_RATEPAY_RECHNUNG_PDF_FON; ?> <?php echo $fon; ?> <?php echo PI_RATEPAY_RECHNUNG_PDF_BULL; ?> <?php echo PI_RATEPAY_RECHNUNG_PDF_FAX; ?> <?php echo $fax; ?> <?php echo PI_RATEPAY_RECHNUNG_PDF_BULL; ?> <?php echo PI_RATEPAY_RECHNUNG_PDF_EMAIL; ?> <?php echo $email; ?></span><br/>
            <span><?php echo PI_RATEPAY_RECHNUNG_PDF_OWNER; ?> <?php echo $owner; ?> <?php echo PI_RATEPAY_RECHNUNG_PDF_BULL; ?> <?php echo PI_RATEPAY_RECHNUNG_PDF_COURT; ?> <?php echo $court; ?> <?php echo PI_RATEPAY_RECHNUNG_PDF_BULL; ?> <?php echo PI_RATEPAY_RECHNUNG_PDF_HR; ?> <?php echo $hr; ?> <?php echo PI_RATEPAY_RECHNUNG_PDF_BULL; ?> <?php echo PI_RATEPAY_RECHNUNG_PDF_UST; ?> <?php echo $ust; ?></span><br/>
        </th>
        <th style="text-align:right;">
            <img src="../images/ratepay_rechnung_rgb.png" alt="RatePAY Logo" width="90px" height="25px" style="margin-left:5px;"/>
        </th>
    </tr>
</table>
