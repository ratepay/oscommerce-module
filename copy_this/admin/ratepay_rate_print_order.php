...
require_once(DIR_FS_CATALOG . 'includes/languages/' . $_SESSION['language'] . '/modules/payment/ratepay_rate.php');
...
<html <?php echo HTML_PARAMS; ?>>
    ...
    <body>
        ...
        <div style="font-family:Verdana;font-size:11px;">
            <p><b><?php echo RATEPAY_RATE_PDF_INFO; ?></b></p>
            <span><?php echo RATEPAY_RATE_PDF_ADDITIONALINFO_1; ?></span><br/>
            <span><?php echo RATEPAY_RATE_PDF_ADDITIONALINFO_2; ?><?php echo $piRatepay->shopBankName; ?><?php echo RATEPAY_RATE_PDF_ADDITIONALINFO_3; ?></span><br/>
            <span><?php echo RATEPAY_RATE_PDF_ADDITIONALINFO_4; ?><?php echo $piRatepay->shopBankName; ?><?php echo RATEPAY_RATE_PDF_ADDITIONALINFO_5; ?></span><br/>
            <span><?php echo RATEPAY_RATE_PDF_ADDITIONALINFO_6; ?><?php echo $piRatepay->shopBankName; ?><?php echo RATEPAY_RATE_PDF_ADDITIONALINFO_7; ?></span><br/><br/>
            <span><b><?php echo RATEPAY_RATE_PDF_PAYTRANSFER; ?></b></span><br/>
            <span><b><?php echo $piRatepay->shopOwner; ?>, <?php echo $piRatepay->shopBankName; ?>, <?php echo RATEPAY_RATE_PDF_BANKCODENUMBER; ?> <?php echo $piRatepay->shopSortCode; ?>, <?php echo RATEPAY_RATE_PDF_ACCOUNTNUMBER; ?> <?php echo $piRatepay->shopAccountNumber; ?><b/></span><br/>
            <span><b><?php echo RATEPAY_RATE_PDF_REFERENCE; ?> <?php echo Db::getRatepayOrderDataEntry(Globals::getParam('oID'), 'descriptor');?></b></span>
        </div>
        <br/>
        <div style="font-family:Verdana;font-size:11px;">
            ...
            <table style="font-family:Verdana;font-size:8px;font-weight:normal!important;" width="100%">
                <tr>
                    <th style="text-align:left;font-weight:normal!important;">
                        <span><?php echo $piRatepay->shopOwner; ?> <?php echo RATEPAY_RATE_PDF_BULL; ?> <?php echo $_SERVER['SERVER_NAME']; ?></span><br/>
                        <span><?php echo $piRatepay->shopStreet . ", " . $piRatepay->shopZipCode; ?> <?php echo RATEPAY_RATE_PDF_BULL; ?> <?php echo RATEPAY_RATE_PDF_FON; ?> <?php echo $piRatepay->shopPhone; ?> <?php echo RATEPAY_RATE_PDF_BULL; ?> <?php echo RATEPAY_RATE_PDF_BULL; ?> <?php echo $piRatepay->shopFax; ?> <?php echo RATEPAY_RATE_PDF_FAX; ?> <?php echo RATEPAY_RATE_PDF_EMAIL; ?> <?php echo Db::getShopConfigEntry('STORE_OWNER_EMAIL_ADDRESS'); ?></span><br/>
                        <span><?php echo RATEPAY_RATE_PDF_OWNER; ?> <?php echo $piRatepay->shopOwner; ?> <?php echo RATEPAY_RATE_PDF_BULL; ?> <?php echo RATEPAY_RATE_PDF_COURT; ?> <?php echo $piRatepay->shopCourt; ?> <?php echo RATEPAY_RATE_PDF_BULL; ?> <?php echo RATEPAY_RATE_PDF_HR; ?> <?php echo $piRatepay->shopHr; ?> <?php echo RATEPAY_RATE_PDF_BULL; ?> <?php echo RATEPAY_RATE_PDF_UST; ?> <?php echo Db::getShopConfigEntry('STORE_OWNER_VAT_ID'); ?></span><br/>
                    </th>
