                            ...
                            <table style="width:100%;">
                                ...
                                <tr>
                                    ...
                                    <td style="text-align:right;">
                                        <input type="submit" value="" style="background: url('<?php echo DIR_WS_LANGUAGES . $language; ?>/images/buttons/button_continue.gif') no-repeat; width: 101px; height: 26px; border: none;"/>
                                    </td>
                                </tr>
                            </table>
                        </form>
